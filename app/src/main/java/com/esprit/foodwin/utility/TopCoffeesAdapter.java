...
public class TopCoffeesAdapter extends RecyclerView.Adapter<TopCoffeesAdapter.estabViewHolder> {

    List<Etablissement> estabList;
    Context context;

    public TopCoffeesAdapter() {

    }

    public TopCoffeesAdapter(List<Etablissement> eventList, Context context) {
    ...
    public estabViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.topestab_cell, viewGroup, false);
    ...
    public static class estabViewHolder extends RecyclerView.ViewHolder {
        ...
        public estabViewHolder(@NonNull View itemView) {
            super(itemView);
            image = itemView.findViewById(R.id.topEstabImage2);
            name = itemView.findViewById(R.id.topEstabName2);
            // logo = itemView.findViewById(R.id.topEstabLogo);
            subCat = itemView.findViewById(R.id.topEstabSubCat2);
            rating = itemView.findViewById(R.id.topEstabRating2);
            parentLayout = itemView.findViewById(R.id.estabParentLayout2);
        }
    }
}
