...
public class TopDrinkAdapter extends RecyclerView.Adapter<TopDrinkAdapter.estabViewHolder> {

    List<Etablissement> estabList;
    Context context;

    public TopDrinkAdapter() {

    }

    public TopDrinkAdapter(List<Etablissement> eventList, Context context) {
