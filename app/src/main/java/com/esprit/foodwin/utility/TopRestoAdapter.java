...
public class TopRestoAdapter extends RecyclerView.Adapter<TopRestoAdapter.estabViewHolder> {

    List<Etablissement> estabList;
    Context context;

    public TopRestoAdapter() {

    }

    public TopRestoAdapter(List<Etablissement> eventList, Context context) {
