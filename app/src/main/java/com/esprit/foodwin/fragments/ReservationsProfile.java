...
import com.esprit.foodwin.utility.ProfileReservationsAdapter;


public class ReservationsProfile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_reservations_profile, container, false);
        recyclerView = view.findViewById(R.id.profileResRecyclerView);
        progressBar = view.findViewById(R.id.progressProfileRes);
        sadImg = view.findViewById(R.id.sadImg5);
        sadTxt = view.findViewById(R.id.sadText5);
        loadList();
        return view;
    }
    ...
    private void loadList() {
        ...
        String JSON_URL = IP.ip+"reservations/" + loginsharedPref.getString("id", "");
    //    String JSON_URL = "http://192.168.1.19:3000/reservations/" + loginsharedPref.getString("id", "");
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            ProfileReservationsAdapter adapter = new ProfileReservationsAdapter(getContext(), reservations, images, names);
                            ...
                            if (reservations.size() == 0) {
                                    ...
                                    sadTxt.setText("You have no Reservations");
                                    sadTxt.setAlpha(1);
